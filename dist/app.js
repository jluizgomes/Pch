...
var app = angular.module('peachApp', ['ngRoute','ngAnimate','angular-loading-bar']).config(['cfpLoadingBarProvider', function(cfpLoadingBarProvider) {
...
.controller('listagem', ['$scope', '$http', function($scope, $http) {
