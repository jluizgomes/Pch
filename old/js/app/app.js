...
app.controller('detailController', ['$scope', '$http', '$stateParams','$timeout', function($scope, $http, $stateParams, $timeout) {
...
app.controller('PrivacidadeController', function($scope, $http) {
  console.log('PrivacidadeController');
});
app.controller('PoliticaController', function($scope, $http) {
  console.log('PoliticaController');
});
